...
package 
{
	...
	public class CustomLayoutVideoSwitcherBase extends BaseObject
	{
		protected var _dragAndDrop:CLSV;
		 ...
		 *****************************************************************************/
		public function CustomLayoutVideoSwitcherBase()
		{			
			super();
		}
		...
		public override function initializeScript(propertyArr:Array, systemServiceManager:ISystemServiceManager):void
		{
			...
			var dragAndDropData:CLSVData = new CLSVData();
			...
			_dragAndDrop = new CLSV(controlWidth, controlHeight, systemServiceManager, dragAndDropData);
